...
# Title: Gmsk Rx Tx Real
# Generated: Mon Apr 27 08:23:13 2020
##################################################
...
class gmsk_rx_tx_real(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Gmsk Rx Tx Real")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/steve-wang/rx.txt', True)
...
def main(top_block_cls=gmsk_rx_tx_real, options=None):
